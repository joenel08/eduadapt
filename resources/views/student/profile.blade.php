    ...
    <div class="tabs-container">
            ...
            <div class="tabs-content">
                ...
                <div class="profile-picture-section">
                    <div class="profile-picture" id="profilePictureDisplay"
                        style="@if($student->profile_picture) 
                background-image: url('{{ asset('storage/' . $student->profile_picture) }}'); 
                background-size: cover; 
                background-position: center; 
                @else 
                background: linear-gradient(135deg, #0066CC 0%, #004D99 100%); 
                @endif">
                    ...
                    <div class="profile-picture-upload">
                        <form id="pictureForm" action="{{ route('student.profile.picture') }}" method="POST" enctype="multipart/form-data">
                            @csrf
        ...
        <div id="password" class="tab-pane">
            <div class="tabs-content">
                ...
                <form id="passwordForm" action="{{ route('student.password.update') }}" method="POST">
                    @csrf
                    @method('PUT')
...
<script>
    ...
    document.getElementById('profilePictureInput')?.addEventListener('change', function(e) {
        ...
        if (file) {
            ...
            reader.onload = function(event) {
                ...
                display.innerHTML = `<img src="${event.target.result}" alt="Profile">`;
            };
    ...
    function showAlert(type, message, container = null) {
        const alertElement = container || document.getElementById('alertContainer');
        if (container) {
