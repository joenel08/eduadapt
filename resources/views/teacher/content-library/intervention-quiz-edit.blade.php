...
@section('page_title', 'Edit Intervention Quiz - ' . $subject . ' - ' . $week)
...
<div class="week-content-page">
    <div class="week-header">
        <i class="fas fa-question-circle"></i> Edit Intervention Quiz
    </div>
            ...
            <form id="quizForm" 
                ...
                <div class="randomization-options" id="randomizationOptions">
                    ...
                    <label class="toggle-line">
                        <input type="checkbox" name="shuffle_questions" value="1" {{ ($settings['shuffle_questions'] ?? false) ? 'checked' : '' }}> Shuffle / Randomize Question Order
                    </label>
                    <label class="toggle-line" id="shuffleChoicesRow">
                        <input type="checkbox" name="shuffle_choices" value="1" {{ ($settings['shuffle_choices'] ?? false) ? 'checked' : '' }}> Shuffle / Randomize Choice Order
                    </label>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="due_date" id="due_date" class="form-control" value="{{ $settings['due_date'] ?? '' }}">
                </div>
